...
return [
    ...
    */
    ...
    'default' => env('DB_CONNECTION_MES', 'mysql_mes'),
    ...
    */
    ...
    'connections' => [
        ...
        'mysql_essex' => [
            'driver' => 'mysql',
            'host' => env('DB_HOST_ESSEX', ''),
            'port' => env('DB_PORT_ESSEX', ''),
            'database' => env('DB_DATABASE_ESSEX', ''),
            'username' => env('DB_USERNAME_ESSEX', ''),
            'password' => env('DB_PASSWORD_ESSEX', ''),
            'unix_socket' => '',
            'charset' => 'utf8mb4',
