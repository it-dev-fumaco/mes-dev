...
Route::group(['middleware' => 'auth'], function(){
	...
	Route::post('/update_process', 'SecondaryController@update_process');
...
Route::group(['middleware' => 'auth'], function(){
	...
	// Route::post('/update_bom', 'ManufacturingController@update_bom');
...
Route::get('/print_production_sched_assembly/{date}', 'AssemblyController@get_scheduled_for_assembly');
...
Route::group(['middleware' => 'auth'], function(){
	...
	// Route::get('/assembly/conveyor_assignment/{scheduled_date}', 'AssemblyController@assembly_conveyor_assignment');
