		...
		<div class="row">
			<div class="col-md-6">
				<div class="form-group">
					...
					<select class="form-control" name="reject_list_id">
				...
				<div class="form-group">
					...
					<select class="form-control" name="qa_disposition">
			...
			<div class="col-md-6">
				<div class="form-group">
					...
					<input type="text" name="rejected_qty" class="form-control" value="{{ $qa_details->rejected_qty }}">
				</div>
				<div class="form-group">
					<label class="font-weight-bold">Remarks</label>
					<textarea name="remarks" class="form-control" style="border: 1px solid #dddddd;"></textarea>
				</div>
			</div>
		</div>
	</div>
