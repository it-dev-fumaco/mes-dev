<table id="header-table" class="mb-1" style="width: 100%; border-color: #D5D8DC;">
    <col style="width: 15%;">
    <col style="width: 27%;">
    <col style="width: 23%;">
    <col style="width: 20%;">
...
<div class="container-fluid pt-2">
    <div class="alert alert-warning text-dark p-2"><b>Note: Confirmed Reject Qty will be deducted to the Good Qty</b></div>
    <form action="/submitRejectConfirmation/{{ $production_order_details->production_order }}" method="POST" id="reject-confirmation-form">
        ...
        <table class="table table-bordered mt-3">
            <thead class="bg-secondary text-white text-uppercase" style="font-size: 7pt;">
                ...
                <th class="p-1 text-center bg-danger font-weight-bold" style="width: 12%;">Confirmed Reject Qty</th>
