...
<table style="width: 100%; font-size: 8pt; border-collapse: collapse;">
	<tr style="border-bottom: 1px solid;">
		...
		<th style="width: 65%; text-align: center;">
			<span style="font-size: 12pt;">WITHDRAWAL SLIP</span>
		</th>
...
<div style="font-size: 6pt; font-style: italic; float: right; margin-top: 10px;">Printed by: {{ Auth::user()->employee_name }} - Time: {{date('Y-m-d h:i A') }}</div>
</div>
@endforeach
