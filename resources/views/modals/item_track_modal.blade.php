<!-- Modal -->
<div class="modal fade" id="track-view-modal" tabindex="-1" role="dialog">
   <div class="modal-dialog modal-lg-custom" style="min-width: 90%;" role="document">
         <div class="modal-content">
            <div class="modal-header">
               <h5 class="modal-title" id="modal-title">
                  <i class="now-ui-icons location_pin"></i> Tracking View<br>
               </h5>
