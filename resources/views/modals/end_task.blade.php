...
<div class="modal fade" id="end-task-modal" tabindex="-1" role="dialog">
   <div class="modal-dialog modal-lg" role="document" style="min-width: 70%;">
      <form id="end-task-frm" action="/end_task" method="post" autocomplete="off">
         @csrf
         <div class="modal-content">
            <div class="modal-header text-white" style="background-color: #0277BD;">
               <h5 class="modal-title"><img src="{{ asset('img/task_complete.png') }}" width="30" height="29"> Complete Task [<b>{{$workstation}}</b>]</h5>
