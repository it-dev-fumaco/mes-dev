<!-- Modal -->
<div class="modal fade" id="add-workstation-machine-modal" tabindex="-1" role="dialog">
               ...
               <div class="row">
                  <div class="col-md-12">
                     <div class="form-group">
                        ...
                        <input type="hidden" name="workstation_name" value="{{ $list->workstation_name }}">
                        ...
                        <select name="machine_id" style="width: 260px;"  id="machine_code_selection" class="clearme" onchange="machine_assign_description()">
                           ...
                           <option value="{{ $row->machine_id }}">{{ $row->machine_code }} - {{ $row->machine_name}}
                           </option>
                           @endforeach
                           </select>
                     </div>
