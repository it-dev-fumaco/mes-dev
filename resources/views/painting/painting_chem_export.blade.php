...
<table class="text-center table table-bordered table-responsive" style="width: 100%;" id="ceo">
              ...
              <thead style="font-weight:bold; color:#e67e22;">
                ...
                <tr style="font-size:7pt;">
                  <th style="background-color: #fcf3cf;color:black;border: 1px solid black;line-height: 12px;"><b>Free AKALI(6.5-7.5)</b></th>
                  ...
                  <th style="background-color: #fcf3cf;color:black;border: 1px solid black;line-height: 12px;"><b> Replenishing(16-20)</b></th>
                  <th style="background-color: #fcf3cf;color:black;border: 1px solid black;line-height: 12px;"><b>Status</b></th>
                  <th style="background-color: #fcf3cf;color:black;border: 1px solid black;line-height: 12px;font-size: 10px;"><b>Increase/Decrease</b></th>
                  <th style="background-color: #fcf3cf;color:black;border: 1px solid black;line-height: 12px;" ><b>Accelerator(6-9) </b></th>
                  <th style="background-color: #fcf3cf;color:black;border: 1px solid black;line-height: 12px;"><b>Status</b></th>
                  <th style="background-color: #fcf3cf;color:black;border: 1px solid black;line-height: 12px;font-size: 10px;"><b>Increase/Decrease</b></th>
                </tr>
            ...
            <tbody style="font-size:9pt;">
              ...
              @empty
                 <tr>
                    <td colspan="12" class="text-center" style="font-size: 15pt;">No Record Found</td>
                 </tr>
              @endforelse
