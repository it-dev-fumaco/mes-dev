  ...
  <tbody style="font-size: 9pt;">
    ...
    <tr class="tr-{{ $item['production_order'] }} {{ $item_row }}">
      ...
      <td class="text-justify pl-3">
        <div class="pull-right p-0" style="margin: -8px 0 0 0;">
          <button class="btn btn-sm btn-default change-raw-mat-btn m-0" data-id="{{ $item['id'] }}"  data-req-url="{{ $url }}" style="font-size: 8pt; padding: 3px 5px;">Change</button>
        </div>
