      ...
      <tbody style="font-size: 9pt;">
        ...
        <tr>
          ...
          <td class="text-center" style="font-size: 12pt;">
              <span class="badge tab-heading--{{ ($r['status'] == 'Material For Issue') ? 'reddish' : 'blue' }}">{{ $r['status'] }}</span>
        </td>
          <td class="text-center">
            <div class="btn-group">
        ...
        <center>
          <div class="col-md-12 text-center custom-production-pagination" data-status="Task Queue" data-div="#task-queue-div">
           {{ $q->links() }}
          </div>
        </center>
