<input type="text" class="d-none" id="file_name" value="Rejection-Logs--{{ Carbon\Carbon::parse($min_export_date)->format('m-d-Y').'--'.Carbon\Carbon::parse($max_export_date)->format('m-d-Y') }}">
