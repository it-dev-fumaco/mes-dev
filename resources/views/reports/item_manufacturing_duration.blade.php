@extends('layouts.user_app', [
  'namePage' => 'Data Export',
   ...
   'pageHeader' => 'Item Manufacturing Duration Report',
...
<div class="row p-0" style="margin-top: -190px; margin-bottom: 0; margin-left: 0; margin-right: 0; min-height: 850px;">
   <div class="col-12 mx-auto bg-white p-2">
      <h5 class="text-center font-weight-bold">Item Manufacturing Duration Report</h5>
...
<script>
   $(document).ready(function(){
        ...
        const load = () => {
            ...
            $.ajax({
                url: '/report/item_manufacturing_duration',
                type:"GET",
                data: {
