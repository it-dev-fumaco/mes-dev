  ...
  <div class="container-fluid bg-white">
      <div class="row" style="margin-top: -90px">
          <div class="col-12 mx-auto bg-white p-2">
              <h5 class="text-center font-weight-bold">Completed Material Requests with Pending Production Order</h5>
              ...
              <table class="table table-bordered">
                  <thead style="font-size: 7pt;">
                        <th class="text-center font-weight-bold" style="width: 10%;">Material Request</th>
                        <th class="text-center font-weight-bold" style="width: 25%;">Customer</th>
                        <th class="text-center font-weight-bold" style="width: 10%;">MREQ Status</th>
                  ...
                  <tbody>
                      ...
                      <tr>
                          ...
                          <td rowspan="{{ count($items) }}" class="text-center">{{ $items[0]->mreq_status }}</td>
                          @endif
