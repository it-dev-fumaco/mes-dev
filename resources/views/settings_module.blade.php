 ...
 -->        <div class="col-2" style="margin-top: -160px; height: 500px; padding-right: 0px;">
                ...
                <div class="row" style="background-color: #ffffff;" class="text-center">
                  <div class="col-md-12 text-center">
                        <ul class="nav flex-column workstation_navbar" id="myTab" role="tablist" style="font-size: 10pt;">   <h6 class="text-center" style="padding-top: 10px;">Production</h6>
                            ...
                            <h6 class="text-center" style="padding-top: 10px;">Maintenance</h6>
                            <li class="nav-item">
                                <a class="nav-link" href="#maintenance_sched_type" data-toggle="tab">Maintenance Schedule Type Setup </a>
                            </li>
                            <li class="nav-item">
                              <a class="nav-link" href="#pmt" data-toggle="tab">Preventive Maintenance Task</a>
                            </li>
        ...
        <div class="col-10" style="margin-top: -160px; min-height:1000px; ">
            <div class="tab-content text-center">
                ...
                <div class="tab-pane" id="maintenance_sched_type">
                  <div class="card" style="background-color: #0277BD;" >
                      <div class="card-body" style="padding-bottom: 0;">
                          <div class="row">
                              <div class="col-md-8">
                                  <h5 class="text-white font-weight-bold text-left">Maintenance Schedule Type Setup</h5>
                              </div>
                              <div class="col-md-4">
                                  <div class="form-group">
                                      <input type="text" class="form-control form-control" placeholder="Search" id="search_maintenance_sched_type">
                                  </div>
                              </div>
                          </div>
                          <div class="row" style="background-color: #ffffff;height: auto; min-height: 700px;">
                              <div class="col-md-12">
                                  <button type="button" class="btn btn-primary pull-right" id="add_sched_type_btn" style="margin: 5px;">
                                    <i class="now-ui-icons ui-1_simple-add"></i> Add Schedule Type
                                  </button>
                                    <div class="tbl_add_sched_type" id="tbl_add_sched_type"></div>
                              </div>
                          </div>      
                      </div>
                  </div>
              </div>
              <div class="tab-pane" id="pmt">
                <div class="card" style="background-color: #0277BD;" >
                    <div class="card-body" style="padding-bottom: 0;">
                        <div class="row">
                            <div class="col-md-8">
                                <h5 class="text-white font-weight-bold text-left">Preventive Maintenance Task</h5>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    <input type="text" class="form-control form-control" placeholder="Search" id="search_pmt">
                                </div>
                            </div>
                        </div>
                        <div class="row" style="background-color: #ffffff;height: auto; min-height: 700px;">
                            <div class="col-md-12">
                                <button type="button" class="btn btn-primary pull-right" id="add_pmt_btn" style="margin: 5px;">
                                  <i class="now-ui-icons ui-1_simple-add"></i> Add Task
                                </button>
                                  <div class="tbl_add_pmt_task" id="tbl_add_pmt_task"></div>
                            </div>
                        </div>      
                    </div>
                </div>
...
<div class="modal fade" id="add-sched-type-modal" tabindex="-1" role="dialog">
  <div class="modal-dialog" role="document" style="min-width: 35%;">
     <form action="/add_maintenance_sched_type" method="POST" id="add-sched-type-frm">
        @csrf
        <div class="modal-content">
           <div class="modal-header text-white" style="background-color: #0277BD;">
              <h5 class="modal-title" id="modal-title">
               <span>Add Schedule Type</span>
               <span class="operation-text" style="font-weight: bolder;"></span></h5>
               <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                 <span aria-hidden="true">&times;</span>
               </button>
           ...
           <div class="modal-body">
              <div class="row">
                <div class="col-md-12">
                  <div class="form-group" style="font-size:13pt;">
                    <label for="add_op_sched_type">Operation:</label>
                      <select class="form-control" name="add_op_sched_type" id="add_op_sched_type" required>
                        <option value="">Select Operation</option>
                        @foreach($operations as $row)
                        <option value="{{ $row->operation_id }}">{{ $row->operation_name }}</option>
                        @endforeach
                 ...
                 <div class="col-md-6">
                    <div class="form-group" style="font-size:13pt;">
                        <label style="padding-left: 10px;display:inline;" for="add_sched_type">Schedule Type:</label>
                        <select class="form-control" name="add_sched_type" id="add_sched_type" required>
                 ...
                 <div class="col-md-6">
                  <div class="form-group" style="font-size:13pt;">
                      <label style="padding-left: 10px;display:inline;" for="add_sched_date">Schedule Date:</label>
                      <input type="date" name="add_sched_date" id="add_sched_date" class="form-control" required>
                  </div>
               </div>
              </div>
           </div>
...
<div class="modal fade" id="edit-sched-type-modal" tabindex="-1" role="dialog">
  <div class="modal-dialog" role="document" style="min-width: 35%;">
     <form action="/edit_maintenance_sched_type" method="POST" id="edit-sched-type-frm">
        @csrf
        <div class="modal-content">
           <div class="modal-header text-white" style="background-color: #0277BD;">
              <h5 class="modal-title" id="modal-title">
               <span>Edit Schedule Type</span>
               <span class="operation-text" style="font-weight: bolder;"></span></h5>
               <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                 <span aria-hidden="true">&times;</span>
               </button>
           ...
           <input type="hidden"  name="orig_edit_sched_type" id="orig_edit_sched_type">
           <input type="hidden"  name="orig_edit_sched_date" id="orig_edit_sched_date">
           <input type="hidden"  name="orig_edit_op_sched_type" id="orig_edit_op_sched_type">
           <input type="hidden" name="id_mtype" id="id_mtype">
           <div class="modal-body">
              <div class="row">
                <div class="col-md-12">
                  <div class="form-group" style="font-size:13pt;">
                    <label for="edit_op_sched_type">Operation:</label>
                      <select class="form-control" name="edit_op_sched_type" id="edit_op_sched_type" required>
                        <option value="">Select Operation</option>
                        @foreach($operations as $row)
                        <option value="{{ $row->operation_id }}">{{ $row->operation_name }}</option>
                        @endforeach
                 ...
                 <div class="col-md-6">
                    <div class="form-group" style="font-size:13pt;">
                        <label style="padding-left: 10px;display:inline;" for="edit_sched_type">Schedule Type:</label>
                        <select class="form-control" name="edit_sched_type" id="edit_sched_type" required>
                          <option value="">Select Schedule Type</option>
                          <option value="Weekly">Weekly</option>
                          <option value="Monthly">Monthly</option>
                          <option value="Quarterly">Quarterly</option>
                 ...
                 <div class="col-md-6">
                  <div class="form-group" style="font-size:13pt;">
                      <label style="padding-left: 10px;display:inline;" for="edit_sched_date">Schedule Date:</label>
                      <input type="date" name="edit_sched_date" id="edit_sched_date" class="form-control" required>
                  </div>
               </div>
              </div>
           </div>
...
<div class="modal fade" id="delete-sched-type-modal" tabindex="-1" role="dialog">
  <div class="modal-dialog" role="document" style="min-width: 35%;">
     <form action="/delete_maintenance_sched_type" method="POST" id="delete-sched-type-frm">
        @csrf
        <div class="modal-content">
           <div class="modal-header text-white" style="background-color: #0277BD;">
              <h5 class="modal-title" id="modal-title">
               <span>Delete Schedule Type</span>
               <span class="operation-text" style="font-weight: bolder;"></span></h5>
               <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                 <span aria-hidden="true">&times;</span>
               </button>
           ...
           <input type="hidden" name="del_id_mtype" id="del_id_mtype">
           <div class="modal-body">
              <div class="row">
                <div class="col-md-12">
                  <div class="form-group" style="font-size:13pt;">
                    <label for="delete_op_sched_type">Are you sure you want to delete</label><label id='label_msched_type' style="padding-left:5px;font-weight:bold;"></label><label style="padding-left:5px;">from </label><label id="label_op_mtype" style="padding-left:5px;font-weight:bold;"></label>?
...
<div class="modal fade" id="add-pmt-modal" tabindex="-1" role="dialog">
  <div class="modal-dialog" role="document" style="min-width: 35%;">
     <form action="/add_preventive_maintenance_task" method="POST" id="add-pmt-frm">
        @csrf
        <div class="modal-content">
           <div class="modal-header text-white" style="background-color: #0277BD;">
              <h5 class="modal-title" id="modal-title">
...
#add-sched-type-modal .form-control{
    border: 1px solid #ccc;
  border-radius: 3px;
  box-shadow: none;
  margin-bottom: 15px;
...
<script>
  ...
  $(document).on('click', '.btn_edit_reason_for_cancellation', function(){
    ...
    $(document).on('click', '#add_sched_type_btn', function(){
      $('#add-sched-type-modal').modal('show');
    });
    get_list_maintenance_sched_type();
    function get_list_maintenance_sched_type(page, query){
        $.ajax({
          url:"/get_list_maintenance_sched_type?page="+page,
          data: {search_string: query},
          type:"GET",
          success:function(data){
            $('#tbl_add_sched_type').html(data);
          }
        }); 
    }
    $('#add-sched-type-frm').submit(function(e){
      e.preventDefault();
      var url = $(this).attr("action");
      $.ajax({
        url: url,
        ...
        success:function(data){
          if (data.success < 1) {
            ...
            showNotification("success", data.message, "now-ui-icons ui-1_check");
            $('#add-sched-type-modal').modal('hide');
            get_list_maintenance_sched_type();
    ...
    $(document).on('click', '#search_maintenance_sched_type_pagination a', function(event){
      event.preventDefault();
      var query = $('#search_maintenance_sched_type').val();
      var page = $(this).attr('href').split('page=')[1];
      get_list_maintenance_sched_type(page, query);
    })
    $(document).on('keyup', '#search_maintenance_sched_type', function(){
      var query = $(this).val();
      get_list_maintenance_sched_type(1, query);
    });
    $(document).on('click', '.edit-main-sched-btn', function(){
      var maintype = $(this).data('maintype');
      var maintypeid = $(this).data('maintypeid');
      var opid = $(this).data('opid');
      var startdate = $(this).data('startdate');
      $('#orig_edit_sched_type').val(maintype);
      $('#orig_edit_sched_date').val(startdate);
      $('#orig_edit_op_sched_type').val(opid);

      $('#id_mtype').val(maintypeid);
      $('#edit_sched_type').val(maintype);
      $('#edit_sched_date').val(startdate);
      $('#edit_op_sched_type').val(opid);
      $('#edit-sched-type-modal').modal('show');
    });
    $('#edit-sched-type-frm').submit(function(e){
      e.preventDefault();
      var url = $(this).attr("action");
      $.ajax({
        url: url,
        ...
        success:function(data){
          if (data.success < 1) {
            ...
            showNotification("success", data.message, "now-ui-icons ui-1_check");
            $('#edit-sched-type-modal').modal('hide');
            get_list_maintenance_sched_type();
    ...
    $(document).on('click', '.delete-main-sched-btn', function(){
      var maintype = $(this).data('maintype');
      var opname = $(this).data('opname');
      var maintypeid = $(this).data('maintypeid');
      $('#label_msched_type').text(maintype);
      $('#label_op_mtype').text(opname);
      $('#del_id_mtype').val(maintypeid);
      $('#delete-sched-type-modal').modal('show');
    });
    $('#delete-sched-type-frm').submit(function(e){
      e.preventDefault();
      var url = $(this).attr("action");
      $.ajax({
        url: url,
    ...
    $(document).on('click', '#add_pmt_btn', function(){
      $('#add-pmt-modal').modal('show');
    });
    function add_row_task(){
          var thizz = document.getElementById('pmt-task-table');
          var id = $(thizz).closest('table').find('tr:last td:first').text();
          var validation = isNaN(parseFloat(id));
          if(validation){
            var new_id = 1;
          ...
          var len2 = new_id;
          var id_unique1="machine"+len2;
          var tblrow = '<tr>' +
            '<td style="display:none;">'+len2+'</td>' +
            '<td class="p-1"><div class="form-group m-0"><input type="hidden"><textarea class="form-control m-0" name="pm_task[]" rows="2" style="border:1px solid  #cccccc;" id="pm_task_desc" required></textarea></div></td>' +
            '<td class="p-1"><div class="form-group m-0"><input type="hidden"><textarea class="form-control m-0" name="pm_task_desc[]" rows="2" style="border:1px solid  #cccccc;" id="pm_task_desc" required></textarea></div></td>' +
          ...
          $("#add-pmt-modal #pmt-task-table").append(tblrow);

    }
    $(document).on('click', '#add-row-task-btn', function(){
      add_row_task();
    });
    $('#add-pmt-frm').submit(function(e){
      e.preventDefault();
      var url = $(this).attr("action");
      $.ajax({
        url: url,
    ...
    get_preventive_maintenance_task();
    function get_preventive_maintenance_task(page, query){
        $.ajax({
          url:"/get_preventive_maintenance_task?page="+page,
          data: {search_string: query},
          type:"GET",
          success:function(data){
            $('#tbl_add_pmt_task').html(data);
          }
        }); 
    }
</script>
