...
<div class="row p-1" style="margin-top: -213px; margin-bottom: 0; margin-left: 0; margin-right: 0; min-height: 850px;">
    ...
    <div class="card">
      <div class="card-header">
        <div class="row">
          ...
          <div class="col-md-6 text-right" style="float: right;margin-top: -30px;"><h6 class="text-center" style="padding-top: 30px;display: inline-block;">Legend:</h6>
                ...
                <div class="card" style="z-index:0;">
                  ...
                  <div class="card-body">
                    ...
                    <table class="table table-bordered" style="margin-top: 5px;">
                      ...
                      <tbody id="shiftsched-table"></tbody>
                    </table>
                    <div class="pull-left">
  ...
  <div class="modal-dialog" role="document" style="min-width:40%;">
    <form action="/calendar_update_rescheduled_delivery_date" id="calendar_update_rescheduled_delivery_date_form" method="POST">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <div class="row">
            <div class="col-md-12" id="tbl_container_details"></div>
          </div>
        </div>
...
function printElem(div1) {
  ...
  popupWin.document.write('<html><title></title>'+link+'<style>'+styles+'</style></head><body">')
