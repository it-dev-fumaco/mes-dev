          ...
          <div class="btn-group">
            ...
            <div class="dropdown-menu">
              ...
              <a href="#" class="dropdown-item close-production-btn" style="padding-left: 15px;"
                data-production-order="{{ $row['production_order'] }}" data-tabselected="notstarted">Close</a>
              @endcanany

              @canany(['cancel-production-order'])
              <a href="#" class="dropdown-item cancel-prod-btn" style="padding-left: 15px;"
                data-prod="{{ $row['production_order'] }}" data-tabselected="notstarted">Cancel</a>
              @endcanany

              @canany(['reschedule-delivery-date-production-order' ])
              <a href="#" class="dropdown-item reschedule-prod-btn " style="padding-left: 15px;"
                data-prod="{{ $row['production_order'] }}" data-tabselected="notstarted">Reschedule</a>
              <a href="#" class="dropdown-item unschedule-prod-btn " style="padding-left: 15px;"
                data-prod="{{ $row['production_order'] }}" data-tabselected="notstarted">Unschedule</a>
              @endcanany
