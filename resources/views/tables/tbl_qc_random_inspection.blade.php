...
<div class="row">
   <div class="col-md-12">
      ...
      <ul class="nav nav-tabs" id="qi-tabs-1" role="tablist" style="display: none;">
         <li class="nav-item">
            <a class="nav-link active" id="first-tab-random-inspection" data-toggle="tab" href="#tab1-random-inspection" role="tab" aria-controls="tab1" aria-selected="true">QC</a>
         </li>
         <li class="nav-item">
            <a class="nav-link" id="second-tab-random-inspection" data-toggle="tab" href="#tab2-random-inspection" role="tab" aria-controls="tab2" aria-selected="false">Confirm</a>
         </li>
         <li class="nav-item">
            <a class="nav-link" id="third-tab-random-inspection" data-toggle="tab" href="#tab3-random-inspection" role="tab" aria-controls="tab3" aria-selected="false">Confirm</a>
         </li>
      </ul>
      <!-- Tab panes -->
            ...
            <div class="tab-pane active" id="tab1-random-inspection" role="tabpanel" aria-labelledby="first-tab">
               <div class="row" style="min-height: 420px;">
                  <div class="col-md-6">
                     ...
                     <input type="hidden" name="id" value="{{ $job_ticket_details->time_log_id }}">
                     <input type="hidden" name="qc_type" value="Random Inspection">
                     <input type="hidden" name="qc_inspection_status" id="qc-status" value="QC Failed">
               ...
               <div class="row" style="min-height: 420px;">
                  <div class="col-md-6">
                    ...
                    <div class="form-group" id="sel-rejection-type">
                        ...
                        <select class="form-control form-control-lg" style="font-size: 16pt;" name="rejection_type" id="rejection-type">
...
<div id="qc-tab3" style="display: none;">
   <div class="tab-pane" id="tab3-random-inspection" role="tabpanel" aria-labelledby="third-tab">
      <div class="row" style="min-height: 420px;">
...
<div id="qc-enter-rework" style="display: none;">
   <div class="row">
      <div class="col-md-12">
         <div class="form-group text-center">
            <label for="reject-qty">Rework Qty</label>
            <input type="text" class="form-control form-control-lg" name="rework_qty" id="rework-qty" value="{{ $job_ticket_details->reject }}" readonly required style="font-size: 20pt; text-align: center; font-weight: bolder;">
         </div>
      </div>
   </div>
   <div class="text-center numpad-div">
      <div class="row1">
         <span class="numpad num-rework">1</span>
         <span class="numpad num-rework">2</span>
         <span class="numpad num-rework">3</span>
      </div>
      <div class="row1">
         <span class="numpad num-rework">4</span>
         <span class="numpad num-rework">5</span>
         <span class="numpad num-rework">6</span>
      </div>
      <div class="row1">
         <span class="numpad num-rework">7</span>
         <span class="numpad num-rework">8</span>
         <span class="numpad num-rework">9</span>
      </div>
      <div class="row1">
         <span class="numpad del-rework"><</span>
         <span class="numpad num-rework">0</span>
         <span class="numpad clear-rework">Clear</span>
      </div>
   </div>
</div>
