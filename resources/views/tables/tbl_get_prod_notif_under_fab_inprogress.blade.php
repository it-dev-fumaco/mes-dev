                    ...
                    <col style="width: 20%;">
                      ...
                      <tbody>
                        ...
                        @php
                          ...
                          <tr>
                            <td>{{ $index + 1 }}</td>
                            <td><a href="#" class="prod_order_link_to_search d-block" data-prod="{{ $row['production_order'] }}" style="color:black;font-weight:bold;">{{ $row['production_order'] }}</a>
                              @php
                          ...
                          <span class="badge badge-{{ $badge }}">{{ $row['status'] }}</span></td>
