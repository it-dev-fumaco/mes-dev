        ...
        @if (isset($employee_names[$row->user_access_id]))
          <tr>
            ...
            <td class="p-2 text-center">
                <button type="button" class="btn pb-2 pt-2 pr-3 pl-3 btn-danger hover-icon delete-allowed-fast-issuance-user-btn" data-id="{{ $row->fast_issuance_user_id }}" data-username="{{ $employee_names[$row->user_access_id] }}">
