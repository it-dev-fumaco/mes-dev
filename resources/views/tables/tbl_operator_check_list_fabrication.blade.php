  ...
  <tbody style="font-size: 12px;">
    ...
    <tr>
      ...
      <td class="text-center p-2">
        <button type='button' class='btn btn-default pb-2 pt-2 pr-3 pl-3 btn-delete-opchecklist hover-icon' data-id="{{$row->operator_reject_list_setup_id}}" data-workstation="{{$row->workstation_name}}" data-rejectchecklist="{{$row->reject_reason}}" data-operation="{{$row->operation_name}}" data-reloadtbl="Fabrication" data-toggle="modal"><i class='now-ui-icons ui-1_simple-remove'></i></button>
      </td>
      @empty
      <tr>
