                      ...
                      <tbody>
                        @foreach($data as $row)
                          <tr>
                            ...
                            <td class="text-center"><a href="#" class="hover-icon"  data-toggle="modal" data-target="#delete-assigned-to-machine-process-{{ $row->id }}-modal">
                              ...
                              {{--@include('modals.delete_workstation_to_process_modal')--}}
                              </td>
