      ...
      <div class="col-md-12">
        <div class="card">
          <div class="card-header">
            <div class="row">
              <div class="col-md-8">
                <a href="/production_schedule/3" class="pull-left">
              <img src="{{ asset('storage/back.png') }}"  width="40" height="40"/>
            </a>
                  <h5 class="text-black font-weight-bold align-middle" style="padding-left: 60px;">Production Calendar</h5>
              </div>
   ...
   <div class="modal-dialog modal-md" role="document">
         <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <input type="button" class="btn btn-primary" id="assembly_update" value="Save">
            </div>
         </div>
   </div>
</div>
      ...
      var calendar = $('#calendar').fullCalendar({
        ...
        if (event.status == "Completed") {
                  ...
                  // alert(event.id + ' was dropped on ' + event.start.format());
                    $.ajax({
                        url: '/calendar_assembly/update_planned_start_date',
                        type: 'POST',
        ...
        var fortooltip= prod+ '<br><span style="font-size:14px;">'+ tooltp +'<br>'+  p+'<br>'+ delivery_date +'<br>'+ r +'<br>'+ qty+'</span>';
         ...
         eventSources: [{
            url: '/get_production_schedule_calendar_assembly',
            type: 'GET',
            error: function() {
...
<script type="text/javascript">
  $('#assembly_update').click(function(e) {
        e.preventDefault();
        var data = {
            _token: '{{ csrf_token() }}',
            prod_id: $('#prod_no').val(),
        ...
        $.post('{{ route('assembly.ajax_update') }}', data, function( result ) {
