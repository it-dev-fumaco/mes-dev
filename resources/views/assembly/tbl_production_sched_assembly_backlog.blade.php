        ...
        <td>
             <div class="btn-group">
               ...
               <div class="dropdown-menu">
                 <a class="dropdown-item btn-movedtoday" href="#" id="btn-movedtoday" data-workstationid="{{-- $row['workstation_id'] --}}" data-jtid="{{-- $row['jtname'] --}}" data-workstation="{{-- $row['workstation_plot'] --}}" data-qtyaccepted="{{-- $row['qty_accepted'] --}}" data-prod="{{$row['production_order']}}">Move Today</a>
                 <a class="dropdown-item view-process-qty-btn" href="#" data-prod="{{$row['production_order']}}" data-qty="{{ $row['qty'] }}">View Process</a>
               </div>
             </div>
           </td>
      </tr>
